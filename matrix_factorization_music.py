...
class MF_KBIPS_Gau(nn.Module):
    ...
    def fit(self, x, y, y_ips=None, G=4, gamma = 1, C = 1e-5,
        ...
        self.W.load_state_dict(torch.load('data/yahoo/yahoo_user.pth'))
        self.H.load_state_dict(torch.load('data/yahoo/yahoo_item.pth'))
...
class MF_AKBDR_Gau(nn.Module):
    ...
    def fit(self, x, y, y_ips=None,gamma = 1,C=1e-2,num_w_epo = 3,J=3,
